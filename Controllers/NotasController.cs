...
namespace SGE.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MateriasId,AlunosId,EtapasId,NotasAlunos")] Notas notas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MateriasId,AlunosId,EtapasId,NotasAlunos")] Notas notas)
        {
            if (id != notas.Id)
            {
                return NotFound();
